class Property:
    def __init__(
            self, area: float, rooms: int, price: int, address: str
    ):
        self.area = area
        self.rooms = rooms
        self.price = price
...
class House(Property):
    def __init__(
            self, area: float, rooms: int, price: int, address: str, plot: int
    ):
...
class Flat(Property):
    def __init__(
            self, area: float, rooms: int, price: int, address: str, floor: int
    ):
        super().__init__(area, rooms, price, address)
        self.floor = floor
